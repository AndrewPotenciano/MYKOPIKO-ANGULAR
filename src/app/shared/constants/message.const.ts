export const MESSAGES = {
  HOMEPAGE_HERO_TITLE: 'Start your day',
  HOMEPAGE_HERO_SUBTITLE: 'with the perfect coffee',
  ...
  MENU_HEADER_SUBTITLE: 'Brewed to perfection, served with passion.',

  PAYMENT_SELECT_PAYMENT: 'Select Payment Method',
  ...
  TRACK_TRACK_SUB: 'You can now track the status of your delivery here',

  LOGIN_DESCRIPTION: 'Buy Coffees, access your orders, track deliveries, and enjoy exclusive member perks.',
